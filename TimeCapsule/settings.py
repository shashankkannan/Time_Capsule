...
SECRET_KEY = 'django-insecure-6ey$e8qu)yj%=7cr#eip-k%_lyq7+o*322l_05!1n%c_dkkdbh'
...
INSTALLED_APPS = [
    ...
    'TimeCapsuleManagement.apps.TimeCapsuleManagementConfig',
    "SearchCapsule.apps.SearchCapsuleConfig"
]
